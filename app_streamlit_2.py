...
def preparar_tabela_precipitacao(
    ...
    if out["precipitacao_mm"].isna().any():
        erros.append(f"A tabela '{nome_tabela}' possui precipitações vazias ou inválidas.")
...
st.markdown(
    ...
    <div class="warning-box">
        <strong>Aviso:</strong> {LIMITATION_NOTE}
    </div>
    ''',
    unsafe_allow_html=True,
)
...
# ============================================================
# CARREGAMENTO DOS MODELOS DISPONÍVEIS
# ============================================================
